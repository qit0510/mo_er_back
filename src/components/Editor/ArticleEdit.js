              ...
              <Card>
                ...
                >
                  {getFieldDecorator('column_id', {
                    initialValue: this.props.data.column_id,
                ...
                >
                  {getFieldDecorator('tag_ids',{
                    initialValue: this.props.data.tags && this.props.data.tags.map(item=>item.id),
                  })(<Checkbox.Group>
                    <Row>
                      {
...
const WrappedRegistrationForm = Form.create()(ArticleEdit);
